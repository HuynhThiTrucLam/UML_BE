...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "absent_forms_student_id_fkey", "absent_forms", type_="foreignkey"
    )
    op.create_foreign_key(None, "absent_forms", "students", ["student_id"], ["id"])
    op.alter_column(
        "course_registrations", "student_id", existing_type=sa.UUID(), nullable=True
    )
    op.create_index(
        op.f("ix_course_registrations_id"), "course_registrations", ["id"], unique=False
    )
    op.drop_constraint(
        "course_registrations_student_id_fkey",
    ...
    op.create_foreign_key(
        None, "course_registrations", "students", ["student_id"], ["id"]
    )
    op.create_foreign_key(
        None, "course_registrations", "courses", ["course_id"], ["id"]
    )
    op.add_column("courses", sa.Column("license_type_id", sa.UUID(), nullable=False))
    op.alter_column(
        "courses", "course_name", existing_type=sa.VARCHAR(), nullable=False
    )
    ...
    op.alter_column(
        "license_types", "type_name", existing_type=sa.VARCHAR(), nullable=False
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "students",
        sa.Column(
            "enrollment_number", sa.VARCHAR(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "students",
        sa.Column("course_of_study", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
    ...
    op.create_unique_constraint(
        "license_types_type_name_key", "license_types", ["type_name"]
    )
    op.alter_column(
        "license_types", "type_name", existing_type=sa.VARCHAR(), nullable=True
    )
    op.add_column(
        "health_check_schedules",
        sa.Column(
    ...
    op.drop_index(
        op.f("ix_health_check_documents_student_id"),
        table_name="health_check_documents",
    )
    op.alter_column(
        "health_check_documents",
        "health_check_id",
    ...
    op.alter_column(
        "course_registrations", "student_id", existing_type=sa.UUID(), nullable=False
    )
    op.drop_constraint(None, "absent_forms", type_="foreignkey")
    op.create_foreign_key(
        "absent_forms_student_id_fkey",
        "absent_forms",
        "students",
        ["student_id"],
        ["id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["student_id"],
            ["students.id"],
            name="student_health_checks_student_id_fkey",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name="student_health_checks_pkey"),
    )
    op.create_index(
        "ix_student_health_checks_id", "student_health_checks", ["id"], unique=False
    )
    # ### end Alembic commands ###
