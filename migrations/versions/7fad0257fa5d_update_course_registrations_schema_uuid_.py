...
def upgrade() -> None:
    ...
    op.add_column(
        "course_registrations", sa.Column("created_at", sa.String(), nullable=False)
    )
    op.add_column(
        "course_registrations", sa.Column("updated_at", sa.String(), nullable=False)
    )
    op.add_column(
        "course_registrations", sa.Column("method", sa.String(), nullable=False)
    )
    op.add_column(
        "course_registrations",
