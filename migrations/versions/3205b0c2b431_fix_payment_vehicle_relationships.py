...
def upgrade() -> None:
    ...
    op.drop_constraint('payments_course_registration_id_fkey', 'payments', type_='foreignkey')
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'course_registration_schedule'):
        op.create_table('course_registration_schedule',
            ...
            sa.ForeignKeyConstraint(['course_registration_id'], ['course_registrations.id'], ),
