...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_schedules_schedule_datetime'), 'schedules', ['schedule_datetime'], unique=False)
    op.create_index(op.f('ix_schedules_start_time'), 'schedules', ['start_time'], unique=False)
    op.create_index(op.f('ix_schedules_end_time'), 'schedules', ['end_time'], unique=False)
    op.create_index(op.f('ix_schedules_location'), 'schedules', ['location'], unique=False)
    op.create_index(op.f('ix_schedules_type'), 'schedules', ['type'], unique=False)
    op.create_index(op.f('ix_schedules_instructor_id'), 'schedules', ['instructor_id'], unique=False)
    op.create_index(op.f('ix_schedules_vehicle_id'), 'schedules', ['vehicle_id'], unique=False)
