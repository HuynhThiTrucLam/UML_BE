...
class HealthCheckSchedule(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("status IN ('scheduled', 'in_progress', 'completed', 'canceled')", name="check_status_valid"),
    )
    ...
    status = Column(String, nullable=False, default="scheduled")  # scheduled, in_progress, completed, canceled
